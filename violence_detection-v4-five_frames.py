"""
violence_detection_v4-five_frames.py

- Creates predictions after analyzing 5 sequential frames
"""
...
violence_detector = joblib.load('violence_detector_seq.pkl')
...
try:
    ...
    parser.add_argument("--image_dir", default="../../../research_dataset/social_behaviour_labeled/1_act_06-1", help="Process a directory of images. Read all standard formats (jpg, png, bmp, etc.).")
    ...
    # this list will store the data from the 5 most recent frames
    curr_batch = []
    ...
    if mode == '0':
        ...
        while rval:
            ...
            if len(curr_batch) == 5:
                # we have 5 frames we can process, seq_results is fed to our model
                seq_results = curr_batch[0] + curr_batch[1] + curr_batch[2] + curr_batch[3] + curr_batch[4]
